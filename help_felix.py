...
adjacency = np.load("STGCN-PyTorch-master/data/adj_mat.npy")
print(adjacency.dtype)

adjacency_alpha = np.load("STGCN-PyTorch-master/data/adj_mat_alpha.npy")
print(adjacency_alpha.dtype)

node_vals = np.load("STGCN-PyTorch-master/data/node_values.npy")
print(node_vals.dtype)

node_vals_alpha = np.load("STGCN-PyTorch-master/data/node_values_alpha.npy")
