...
# time_set = "feb5_feb18"
time_set = "jun17_jun30"
txt_directory = "test_data/" + junc_set + "/" + time_set
csv_directory = "test_data/" + junc_set + "/csv_" + time_set
...
f = open("test_data/" + junc_set + "/" + junc_set + "_" + time_set + "_info.txt", "w")
